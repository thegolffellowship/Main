...
parses purchase data, and displays it in a web dashboard.
"""
...
# ---------------------------------------------------------------------------
def check_inbox():
    """Fetch new transaction emails, parse them, and save to DB."""
    ...
    transactions = parse_emails(emails)
    if transactions:
        count = save_transactions(transactions)
        logger.info("Saved %d new transactions", count)
