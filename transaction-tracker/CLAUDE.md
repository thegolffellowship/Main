...
- `docs/claude/runbook-sa-championship-2026-08-01.md` (first live shadow: SA CHAMPIONSHIP at The Quarry — pre-flight, the Quarry front-nine par gap, and what to record on the day)
